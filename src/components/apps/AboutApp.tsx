...
export function AboutApp({ onAchievement }: AboutAppProps) {
    ...
    <div className="h-full flex flex-col bg-white select-none overflow-auto">
      <div className="p-6 md:p-8 space-y-8">
        ...
        <h1
          ...
          style={{ fontSize: 'clamp(6rem, 22.5vw, 15rem)' }}
        >
          MATEUS
          <br />
          MUSTE
          ...
          <div className="space-y-2">
            {projects.map((p, i) => (
              ...
              >
                ...
                <div className="font-mono text-[10px] text-gray-500 group-hover:text-gray-300">
                  {p.s}
                </div>
